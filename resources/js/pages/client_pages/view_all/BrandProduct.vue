  ...
  <section class="py-8 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 lg:px-8 grid grid-cols-12 gap-8">
      ...
      <aside class="col-span-12 md:col-span-3 space-y-6">
        ...
        <!-- Brand Filter (optional, যদি brands পাঠাও) -->
        <div v-if="props.filters?.brands" class="bg-white rounded shadow p-4">
          <h3 class="font-semibold mb-3">Brands</h3>
          <div class="space-y-2">
            <label v-for="brand in props.filters.brands" :key="brand.id" class="flex items-center gap-2">
      ...
      <div class="col-span-12 md:col-span-9">
        ...
        <h2 class="text-xl font-bold mb-6">Products Of {{ brand.name }}</h2>
