...
console.log(flash);
// deleted
function confirmDelete(categorySlug: string) {
    if (confirm('Are you sure you want to delete this slider?')) {
        router.delete(`/categories/${categorySlug}`);
    }
}
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    >
                        ...
                        <!-- Description -->
                        <td class="px-6 py-4">
                            {{ truncate(category.description, 5) }}
                        </td>
                        ...
                        <td class="px-6 py-4 space-x-2">
                            ...
                            >
                             ...
                             <button @click="confirmDelete(category.slug)"
