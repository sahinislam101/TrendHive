  ...
  <section class="py-10">
    <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
      ...
      <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold flex items-center gap-2">🏷️ Browse By Brand</h2>
      ...
      <div ref="scrollContainer" class="flex gap-6 overflow-x-auto scrollbar-hide scroll-smooth pb-2">
        <Link :href="`/brand/${brand.slug}`" v-for="brand in brands" :key="brand.id"
          class="min-w-[140px] bg-white text-center p-6 rounded-lg shadow-none hover:shadow-xl transition-shadow duration-300">
          <img :src="brand.image" alt="image" class="h-16 mx-auto mb-3 object-contain" />
      ...
      <div class="mt-10 text-center">
        <Link href="/allbrads" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-full font-medium">
          View All Brands
        </Link>
      </div>
    </div>
